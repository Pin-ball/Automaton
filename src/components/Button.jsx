    ...
    default:
      classes = clsx(
        ...
        'disabled:bg-neutral-800', {
          'bg-c-yellow-500 border-c-yellow-100 active:bg-c-yellow-500 stroke-c-neutral-900': active,
          'bg-c-neutral-800  border-c-neutral-600 active:bg-c-neutral-900': !active,
